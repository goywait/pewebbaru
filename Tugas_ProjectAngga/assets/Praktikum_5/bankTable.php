<?php
require_once 'part/data_bank_get.php';
    ...
    <div class="container-fluid">
        ...
        <form action="#" method="post">
            ...
            <div class="d-flex justify-content-center ">
                ...
                <div class="col-md-6">
                    <input type="number" class="form-control" name="nomor_rekening" required placeholder="Masukan Rekening">
                </div>
            </div>
            ...
            <div class="d-flex justify-content-center mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-danger"><a style="text-decoration: none; color:white;" href="BankWithTable.php">Reset Data</a></button>

                    <a class="btn btn-secondary" href="BankNoTable.php" role="button">Cek Bank</a>
                </div>
            </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                $nasabah1 = new AccountBank('C001', 'jupri', 6000000);
                $nasabah2 = new AccountBank('C002', 'saprudin', 5350000);
                $nasabah3 = new AccountBank('C003', 'jaka', 2500000);

                $new_iser = new AccountBank($nomor_rekening, $nama, $saldo);

                $array_nasabah = [$nasabah1, $nasabah2, $nasabah3, $new_iser];

                if (isset($_POST['submit'])) {
                    $no = 1;
                    foreach ($array_nasabah as $x) {
                ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $x->nomor ?></td>
