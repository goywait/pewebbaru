...
$array_maha1 = new Mahasiswa(get_NimRandom(), "Faiz Fikri", 2012, "Teknik Informatika", 3.8);
$array_maha2 = new Mahasiswa(get_NimRandom(), "Alissa", 2012, "Teknik Informatika", 3.6);
$array_maha3 = new Mahasiswa(get_NimRandom(), "Rosealie", 2011, "Sistem Informatika", 3.0);
$array_maha4 = new Mahasiswa(get_NimRandom(), "defgi anjar", 2013, "Teknik Informatika", 3.5);
$array_maha5 = new Mahasiswa(get_NimRandom(), "Setiawan", 2015, "Teknik Informatika", 4.0);
            ...
            <table class="table table-bordered data">
                ...
                <tbody>
                    ...
                    foreach ($maha as $mhs) {
                        ...
                        echo '<td class="text-center">' . $mhs->tahun_angkatan . '</br>';
                        echo '<td class="text-center">' . $mhs->ipk . '</br>';
                        echo '<td>' . $mhs->ipk_predikat() . '</td>';
